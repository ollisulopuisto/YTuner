...
const
  ...
  AVR_MAINMENU_IDENTIFIERS = AVR_MAINMENU_IDENTIFIER_ABOUT+';'+AVR_MAINMENU_IDENTIFIER_BOOKMARKS+';'+AVR_MAINMENU_IDENTIFIER_MYSTATIONS+';'+AVR_MAINMENU_IDENTIFIER_LOCAL+';'+AVR_MAINMENU_IDENTIFIER_RADIOBROWSER;
  AVR_MAINMENU_LABELS = '*** YTuner ***;Bookmarks;My Stations;Local Stations;Radio Browser';
